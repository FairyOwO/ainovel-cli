...
- **Gate A 固定套句**:命运齿轮、新篇章、终于明白、这一切说明等总结式套话。优先删除或换成具体行动。
- **Gate B 套路句式**:"不是 X,而是 Y"、"声音不大,却带着……"、"眼中闪过一丝……"等模板句。改为直接动作、短句或白描。
- **Gate C 告诉代替展示**:直接解释心理、动机、氛围。改为身体反应、选择、停顿、物件变化。
- **Gate D 节奏过整**:段落长度接近、连续排比、连续同构句。改为长短交错,高潮处允许短句断开。
- **Gate E 对话同腔**:人人完整解释、标签过密、说教式对白。改为省略、打断、潜台词和角色专属词汇。
- **Gate F 章末升华**:章尾把主题讲透、替读者总结意义。改为停在危机、选择、动作或情绪余波。
